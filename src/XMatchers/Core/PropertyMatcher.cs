        ...
        where TProperty : TMatcher
    {
        ...
        private bool Matches(TObject o, IDescription mismatchDescription)
        {
            try
            {
                ...
                {
                    mismatchDescription.AppendFormat("member {0} value ", _property);
            ...
            {
                mismatchDescription.AppendFormat("and exception has been thrown while accessing property {0}:", _property)
                    .AppendNewLine()
        ...
        {
            description.AppendFormat("member {0} value is ", _property)
