...
namespace XMatchers.Tests
{
    public class EmptyListIsNotEqualToNonEmptyList : ListOfComparisonMatcherFailureTest<int>
    {
        ...
        protected override string ExpectedMatcherDescription => "an empty collection";
        protected override string ExpectedMismatchDescription => "was too short (expected to be of length 1, was 0)";
    }

    public class NonEmptyListIsNotEqualToEmptySet : SetOfComparisonMatcherFailureTest<int>
    {
        protected override int[] ExampleValues => new int[0];
        protected override int[] MatchedValue => new[] { 1 };
        protected override string ExpectedMatcherDescription => "an empty collection";
        protected override string ExpectedMismatchDescription => "collection had length 1";
    }

    public abstract class SetOfComparisonMatcherFailureTest<T>
    {
        ...
        protected SetOfComparisonMatcherFailureTest()
        {
